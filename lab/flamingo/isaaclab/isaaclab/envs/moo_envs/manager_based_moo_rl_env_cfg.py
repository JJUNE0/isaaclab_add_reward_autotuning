...
@configclass
class ManagerBasedMOORLEnvCfg(ManagerBasedEnvCfg):
    ...
    * **Infinite horizon**: the agent needs to bootstrap the value of the state at the end of the episode.
    ...
    moo_rewards: object = MISSING
    """Reward settings.

    Please refer to the :class:`isaaclab.managers.MOORewardManager` class for more details.
    """
