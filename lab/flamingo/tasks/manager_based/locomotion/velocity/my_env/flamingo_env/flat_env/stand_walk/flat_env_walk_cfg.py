...
import lab.flamingo.tasks.manager_based.locomotion.velocity.my_env.flamingo_env.flat_env.stand_walk.walk_reward as mdp_walk
...
@configclass
class FlamingoFlatEnvWalkCfg(LocomotionVelocityFlatEnvCfg):
    ...
    def __post_init__(self):
       ...
       #! ************** scene & observations setup - 0 *********** !#
        ...
        #self.observations.none_stack_policy.velocity_commands = None
        self.observations.none_stack_critic.roll_pitch_commands = None
        self.observations.none_stack_critic.event_commands = None
        #self.observations.none_stack_critic.velocity_commands = None
        ...
        self.actions.wheel_vel.scale = 0.0
        #! ********************************************************* !#
...
@configclass
class FlamingoFlatEnvWalkCfg_PLAY(FlamingoFlatEnvWalkCfg):
