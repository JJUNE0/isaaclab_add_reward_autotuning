...
from .co_rl_cfg import Flamingo4W4LMOOPPORunnerCfg
...
@configclass
class FlamingoRMATeacherRunnerCfg(Flamingo4W4LMOOPPORunnerCfg):
    def __post_init__(self):
        super().__post_init__()
        
        self.max_iterations = 5000
        self.experiment_name = "Flamingo_4w4l_RMA_Teacher"
...
@configclass
class FlamingoRMAStudentRunnerCfg(Flamingo4W4LMOOPPORunnerCfg):
    def __post_init__(self):
        super().__post_init__()
        
        self.max_iterations = 5000
        self.experiment_name = "Flamingo_4w4l_RMA_Student"
        
        self.use_rma_teacher = False
        self.use_rma_student = True
        
        self.policy = RMAStudentActorCriticCfg(
            teacher_checkpoint_path="logs/co_rl/Flamingo_4w4l_RMA_Teacher/mooppo/2026-01-26_11-42-03/model_8100.pt"
        )