...
# Pre-defined configs
##
from lab.flamingo.tasks.moo_based.locomotion.velocity.terrain_config.stair_config_4w4l import ROUGH_TERRAINS_CFG
...
class ObservationsCfg:
    ...
    class StackPolicyCfg(ObsGroup):
        ...
        joint_vel = ObsTerm(func=mdp.joint_vel, noise=Unoise(n_min=-1.5, n_max=1.5), scale=0.05)  # default: -1.5
    ...
    class ProprioceptionCfg(ObsGroup): 
        ...
        base_ang_vel = ObsTerm(func=mdp.base_ang_vel_link, scale=1.0)# default: -1.5
