...
class DomainManagerCfg:
    """
    DomainManager 설정 (5가지 핵심 물리 파라미터)
    """
    
    # 1. [질량] Base Link 질량 추가
    ...
    # 3. [게인] 모터 강성/감쇠 랜덤화
    # TODO : 조인트 별로 다르게 설정 가능하도록 수정 필요
    ...
    # # 4. [조인트 특성] 마찰력(Friction) & 관성(Armature) 랜덤화
    ...
    #         # [신규] Armature (모터 관성) 추가!
    #         # (작은 값이지만 제어에 큰 영향을 줍니다. 보통 0.0 ~ 0.01 사이)
