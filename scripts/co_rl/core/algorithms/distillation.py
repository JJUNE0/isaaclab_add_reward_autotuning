...
# rsl-rl
from scripts.co_rl.core.modules import StudentTeacher, StudentTeacherRecurrent
from scripts.co_rl.core.storage import DistillationRolloutStorage as RolloutStorage
...
class Distillation:
    ...
    def init_storage(
        self, num_envs, num_transitions_per_env, student_obs_shape, teacher_obs_shape, actions_shape
    ):
        # create rollout storage
        self.storage = RolloutStorage(
            num_envs,
            num_transitions_per_env,
            student_obs_shape,          # = obs_shape
            teacher_obs_shape,          # = privileged_obs_shape
            actions_shape,
            None,
            self.device,
        )
