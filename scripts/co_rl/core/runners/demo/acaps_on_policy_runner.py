...
from scripts.co_rl.core.algorithms import ACAPSPPO
...
class ACAPSOnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg, log_dir=None, device="cpu"):
        ...
        assert self.alg_cfg["class_name"] == "ACAPSPPO"
        ...
        alg_class = eval(self.alg_cfg.pop("class_name"))  # ACAPSPPO
        self.alg: ACAPSPPO = alg_class(actor_critic, device=self.device, **self.alg_cfg)
