...
class ACAPSRolloutStorage:
    ...
    def add_transitions(self, transition: Transition):
        ...
        self.actions_difference[self.step].copy_(transition.actions - transition.prev_actions)  # Store actions difference
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield (
                    ...
                    rewards_batch, 
                    prev_rewards_batch,target_values_batch, 
                    advantages_batch, 
                    returns_batch, 
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                yield (obs_batch, critic_obs_batch, actions_batch, 
                       ...
                       values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, (
                    hid_a_batch,
                    hid_c_batch,
                ), masks_batch)
